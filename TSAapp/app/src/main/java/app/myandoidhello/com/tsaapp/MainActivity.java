package app.myandoidhello.com.tsaapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ImageView left = (ImageView) findViewById(R.id.imageViewBack);
        final ImageView right = (ImageView) findViewById(R.id.imageViewForward);
